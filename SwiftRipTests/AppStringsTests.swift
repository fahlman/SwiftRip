...
struct AppStringsTests {
    ...
    @Test func exposesSettingsLabels() {
        ...
        #expect(AppStrings.usageNoticeTitle == "Use SwiftRip Responsibly")
        #expect(AppStrings.usageNoticeMessage.contains("personal backup or archival use"))
        #expect(AppStrings.usageNoticeAcknowledgeTitle == "I Understand")
        #expect(AppStrings.quitTitle == "Quit")
