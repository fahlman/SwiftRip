...
enum AppStrings {
    ...
    nonisolated static let usageNoticeTitle = localized("Use SwiftRip Responsibly")
    nonisolated static let usageNoticeMessage = localized("SwiftRip is intended for personal backup or archival use of DVDs you own or otherwise have the legal right to copy. Laws vary by location. You are responsible for using SwiftRip legally.")
    nonisolated static let usageNoticeAcknowledgeTitle = localized("I Understand")
    nonisolated static let quitTitle = localized("Quit")
